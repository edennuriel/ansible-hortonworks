...
def parse_args():
    ...
    parser.add_argument('--filters', action='store_true', default=None,
                        help='filter condition for server list')
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument('--info', action='store_true',
                        help='print informatino on inventory')
...
def main():
    ...
    try:
        ...
        if args.list:
            ...
            output = get_cache_settings(args.cloud)
        elif args.host:
